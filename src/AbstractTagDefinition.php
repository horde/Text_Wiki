...
abstract class AbstractTagDefinition implements TagDefinition
{
     ...
     * Override for specific nesting rules (e.g., list only allows listitem).
     *
     ...
     * Override for self-closing tags like hr.
     *
